...
gdf = gpd.read_file("data/intermediate/stops_chartreuse_unique.geojson")
...
output_gdf.to_file("data/intermediate/chartreuse_durations.geojson", driver="GeoJSON")

print("✅ Fichier exporté : data/intermediate/chartreuse_durations.geojson")
